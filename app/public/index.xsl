          ...
          <div class="tx">
            <div class="tx-cell">
              <div class="slider-text">
                <ul id="text-slider">
                  <li>
                    <h1>Welcome to SOFTSKY
                    </h1>
                  </li>
                  <li>
                    <h1>We Show Your Security Problems
                    </h1>
                  </li>
                  <li>
                    <h1>We Help Your Business Stay Safe
                    </h1>
                  </li>
                </ul>
                <p>We secure. We believe in the power of protection. No matter what your website represents - it must be safe and secure.
                </p>
              ...
              <div class="embedded-form">
                <h2 style="color:white;">Scan now for free
                </h2>
                  ...
                  <div class="contact-form">
                    <form id="ajax-form-0" name="ajax-form" action="/scan/new" method="post" data-toggle="validator">
                      <div class="row">
                        ...
                        <div class="col-md-6">
                          <label for="name">
                            <span class="error" id="err-name-0">Please enter name
                            </span>
                          </label>
                        ...
                        <div class="col-md-6">
                          <label for="email">
                            <span class="error" id="err-email-0">Please enter e-mail
                            </span>
                            <span class="error" id="err-emailvld-0">Email is not a valid format
                            </span>
                          </label>
                          <input class="form-control" id="email-0" name="email" placeholder="Your Email" type="email"/>
                        </div>
                        <div class="col-md-12 text-right">
                          <button class="btn btn-default btn-lg" id="send-0" type="submit" name="submit">FREE Scan
                          </button>
                        </div>
                      </div>
                      <div class="row">
                        <div class="error text-align-center" id="err-form-0">There was a problem validating the form please check!
                        </div>
                        <div class="error text-align-center" id="err-timedout-0">The connection to the server timed out!
                        </div>
                        <div class="error" id="err-state-0">
                        </div>
                      </div>
                    </form>
                    <div id="ajaxsuccess-0">Your scan has been queued. We will send you email when it's started.
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div class="row">
              ...
              <div class="col-md-4 wow zoomIn" data-wow-duration="700ms" data-wow-delay="300ms">
                <div class="services-box">
                  ...
                  <div class="services-detail">
                    <h4>Free Quick Security Audit
                    </h4>
                    <p>Our heuristics quickly analyze your network configuration/services
                      to determine if you might have security issues.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div class="col-md-4 wow zoomIn" data-wow-duration="700ms" data-wow-delay="400ms">
                <div class="services-box">
                  ...
                  <div class="services-detail">
                    <h4>Full Security Audit
                    </h4>
                    <p>Our robots will analyze your infrastructure and point you to issues that could be used for penetration attack against you.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div class="col-md-4 wow zoomIn" data-wow-duration="700ms" data-wow-delay="500ms">
                <div class="services-box">
                  ...
                  <div class="services-detail">
                    <h4>Expert Security Audit
                    </h4>
                    <p>If something was not found by machine, our experts will manually analyze your system.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div class="col-md-4 wow zoomIn" data-wow-duration="700ms" data-wow-delay="600ms">
                <div class="services-box">
                  ...
                  <div class="services-detail">
                    ...
                    <p>Our Ninja Squad will attempt to find breaches in your website security and report you.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div class="col-md-4 wow zoomIn" data-wow-duration="700ms" data-wow-delay="700ms">
                <div class="services-box">
                  ...
                  <div class="services-detail">
                    ...
                    <p>We understand and websites and webserver differs. We will provide fine configuration tunning to meet your needs.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div class="col-md-4 wow zoomIn" data-wow-duration="700ms" data-wow-delay="800ms">
                <div class="services-box">
                  ...
                  <div class="services-detail">
                    ...
                    <p>We provide high-tech email/phone support for our customers.
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div class="row">
              ...
              <div class="col-md-12 wow fadeInUp" data-wow-duration="700ms" data-wow-delay="500ms">
                <div class="features-intro">
                  ...
                  <p>We want to make Internet safer!
                  </p>
                </div>
              </div>
                  ...
                  <div class="features-left">
                    ...
                    <div class="features-item">
                      ...
                      <div class="features-info">
                        ...
                        <p>We analyze your architectural/coding/configuration issues and plan how to improve.
                        </p>
                      </div>
                    </div>
                    <!-- Features Item #2-->
                    <div class="features-item">
                      ...
                      <div class="features-info">
                        <h4>Staging Preparation
                        </h4>
                        <p>We help you prepare staging server that duplicate your production server.
                        </p>
                      </div>
                    </div>
                    <!-- Features Item #3-->
